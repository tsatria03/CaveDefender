...
description: The pinned nvgt engine now has the opus codec + live mic capture for real-time voice chat
metadata: 
  node_type: memory
  type: project
