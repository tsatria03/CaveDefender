...
description: "CaveDefender runs on a pinned legacy NVGT fork at C:\\nvgt; current upstream NVGT is incompatible — don't suggest upgrading"
metadata: 
  node_type: memory
  type: project
