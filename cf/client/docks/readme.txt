...
Choose a player to open a read-only information card about them, showing their username, nickname, email, pronouns, when they became a member, language channel, rank, whether they are away, where they are, the lobby, a room, or a game, and the version of the game they are running. Staff see a few extra lines on the card about the player's mute, ban, and warning record. Press escape or close to leave the card.
