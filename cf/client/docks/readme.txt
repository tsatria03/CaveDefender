...
On top of that, you can put your pronouns right into your own emotes and your online and offline messages, using short codes the game fills in with the right word for each reader. Write a percent sign and a letter: percent s for the subject, he, she, or they; percent o for the object, him, her, or them; percent d for the possessive, his, her, or their; percent p for the standalone possessive, his, hers, or theirs; percent r for the reflexive, himself, herself, or themself; and percent n for your own name. For example, the emote slash me waves percent d hand reads to everyone as your name followed by waves her hand, his hand, or their hand, matching how each person reads your pronouns. Use a capital letter, such as percent capital s, to capitalize the word at the start of a sentence, which suits an online or offline message. To show a real percent sign, type two of them together, and any code the game does not recognize is left exactly as you typed it.
...
If you are staff, the card also shows action buttons for the things your rank lets you do to that player: kick, ban, promote, demote, notify, warn, silence, set their nickname, reset their password, and delete their account. Only the buttons you are actually allowed to use on that particular player appear, and choosing one asks for anything it needs, such as a ban length, a new rank, a notification, a warning level and reason, the channel to silence and how long, a new nickname, a new password, or a warning to confirm a deletion, before carrying out the same action as the matching staff command. Most of these actions work whether the player is online or offline, so you can use them from an offline player's card, opened through the player list; only kick, private message, and notify need the player to be online. Silencing a player is the staff mute that stops everyone hearing them in a channel you choose, which is different from the personal mute above that quiets them only for you; among the channels you can choose is their online and offline sounds, which makes their connect and disconnect standard for everyone, and the same button also lifts a silence you have set. They never let you do anything the commands would not, so all the usual rank rules still apply; the staff help explains each of these in full.

The player list.

The F6 players menu shows only who is online right now. To see everyone who has an account, including players who are offline, type /playerlist, or /prl. Add on, or online, to list only the players currently online, or off, or offline, to list only those who are not; with nothing after it, a short menu lets you choose which. The online list is alphabetical, each name marked as online, while the offline list puts the most recently seen first and shows when each was last online, for example, arron (offline) Last seen, July 4, 2026 at 1:32 PM. Choosing anyone opens the same information card the players menu opens. For an online player it works exactly as above; for an offline one the card leaves off only what needs the player present, the kick, private message, and notify buttons, and keeps everything else, ban, warn, silence, set nickname, promote, demote, reset password, delete account, and the personal mutes.
...
To set them, type slash onmsg followed by your message, for example slash onmsg has entered the cave, and slash offmsg for your disconnect line. Type slash onmsg default, or slash offmsg default, to go back to the standard wording. You can also set both at once from the change your online and offline messages option in your player panel, which opens a form with a field for each; leave a field blank to use the default. That form also has a show online message and a show offline message button, which take whatever you have typed, even before you save, fill in any pronoun codes, and show you the finished line, name and all, exactly as everyone will read it, so you can check how a message reads and whether it fits before you save. Each message is a single line of up to ninety six characters and is filtered like chat, and only you are told when you change it. Use slash online or slash offline any time to hear your sound and read your message exactly as others will get them. You can also weave your pronouns into these messages with the percent codes described under Pronouns above.
...
You can also put your pronoun codes in a script key's line, the same short codes described under Pronouns above, such as percent d for your possessive. They are not treated as prompts, so a line like slash me waves percent d hand asks you nothing and simply fills in your possessive, and percent percent gives a single literal percent sign. Your codes only fill in when the key sends something that uses them, a slash me emote or your online or offline message; anywhere else, such as a plain global message, they are left exactly as you typed them. One thing to watch: a prompt runs all the way to the next percent sign, so keep any plain words before a prompt or after a code, never between a prompt and a following code, or those words become part of the question.
...
You can also watch a game instead of playing it. Choose watch game from the room menu to see every game in the room, including single-player games and games already in progress, and pick one; how many people can watch a game matches the player limit its host chose, so a game that allows eight players allows eight watchers and an unlimited game takes unlimited watchers, while a single-player game can be watched by any number of people. If a game's watch slots are already full, you are told so, along with how many people are watching.
